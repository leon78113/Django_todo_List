...
def home(request):
	...
	if request.method == "POST":
		...
		api_request = requests.get("http://www.airnowapi.org/aq/observation/zipCode/current/?format=application/json&zipCode=" + zipcode + "&distance=5&API_KEY=5EC6FBC6-7EFD-40B2-A94D-57D35B4A71D6")
		...
		api_request = requests.get("http://www.airnowapi.org/aq/observation/zipCode/current/?format=application/json&zipCode=07310&distance=5&API_KEY=5EC6FBC6-7EFD-40B2-A94D-57D35B4A71D6")
